...
const BookingPage = () => {
  ...
  return (
    <div className='overflow-hidden'>
      <Toaster />
      {/* Header */}
      <div className=' text-gray-950 py-3'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <h1 className='text-xl md:text-2xl font-bold text-center mb-1'>
            Book Your Home Care Service
          </h1>
          <p className='text-md text-center text-blue-950'>
            Professional healthcare delivered to your home in Nairobi
          </p>
        </div>
      </div>
              ...
              {steps.map((step, index) => (
                <React.Fragment key={step.number}>
                  <div className='flex flex-col items-center'>
                    <div
                      className={`w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center font-bold transition-colors ${currentStep >= step.number
                    ...
                    <span
                      className={`mt-2 text-sm font-medium hidden md:block ${currentStep >= step.number
                        ? 'text-blue-600'
                        : 'text-gray-500'
                        }`}
                    >
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`flex-1 rounded-full mb-3 h-1 mx-2 transition-colors ${currentStep > step.number
                        ? 'bg-blue-600'
                        : 'bg-gray-200'
                        }`}
                    />
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='md:col-span-2'>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.fullName ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.email ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.phone ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.area ? 'border-red-500' : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div className='md:col-span-2'>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.address ? 'border-red-500' : 'border-gray-300'
                          }`}
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='md:col-span-2'>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.serviceType
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.serviceDuration
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.preferredDate
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.preferredTime
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      >
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='md:col-span-2'>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:outline-none focus:ring-1 focus:ring-blue-600 ${errors.patientName
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 focus:outline-none border rounded-[0.4em] focus:ring-1 focus:ring-blue-600 ${errors.patientAge
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                        placeholder='Age'
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.patientGender
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-[0.4em] focus:ring-1 focus:outline-none focus:ring-blue-600 ${errors.relationship
                          ? 'border-red-500'
                          : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div className='bg-blue-50 border border-blue-200 rounded-[0.4em] p-2'>
                      <label className='flex items-start gap-3 cursor-pointer'>
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-5 h-5 text-blue-600 rounded focus:ring-0  mt-0.5 ${errors.termsAccepted ? 'border-red-500' : ''
                            }`}
                        />
                        <div>
                          ...
                          <p className='text-sm text-gray-600 mt-1'>
                            I understand that this booking is subject to
                            caregiver availability. Mekin Home Care will contact
                            me within 24 hours to confirm the booking and
                            discuss payment options. I consent to the collection
                            and use of my information as per the privacy policy.
                          </p>
                        </div>
                      </label>
        ...
        <div className='max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-4'>
          <div className='bg-white text-center'>
            ...
            <p className='text-gray-600 mb-6'>
              ...
              your appointment and discuss next steps.
            </p>
            <div className='bg-white rounded-lg mb-2 text-left'>
              ...
              <ul className='space-y-2 text-gray-600'>
                ...
                <li className='flex items-start gap-2'>
                  <CheckCircle className='w-5 h-5 text-blue-600 mt-0.5 shrink-0' />
                  <span>
                    We'll call you to confirm the details and discuss payment
                  </span>
                </li>
                <li className='flex items-start gap-2'>
                  <CheckCircle className='w-5 h-5 text-blue-600 mt-0.5 shrink-0' />
                  <span>Your caregiver will arrive at the scheduled time</span>
                </li>
              </ul>
            </div>
            <p className='text-gray-600 mb-6'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button
                ...
                className='px-6 py-1.5 border border-blue-600 text-blue-600 rounded-lg font-medium hover:bg-blue-50 transition-colors'
              >
                Book another appointment
              </button>
              <Link
                to='/auth/sign-up'
                className='px-6 py-1.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors'
              >
                Sign up to track appointment
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className='sr-only'>
        Book home care Nairobi, schedule nursing care Kenya, elderly care
        booking Nairobi, post-natal care appointment Kenya, physiotherapy
        booking Nairobi, home healthcare scheduling Kenya, caregiver appointment
        Nairobi, disability support booking Kenya, IV therapy appointment
        Nairobi, speech therapy booking Kenya, chronic disease care Nairobi,
        home care services booking Kenya
      </div>
    </div>
  );
};
